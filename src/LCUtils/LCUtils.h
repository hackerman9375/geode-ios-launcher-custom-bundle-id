...
+ (void)signMods:(NSURL *)geodeUrl force:(BOOL)force signer:(Signer)signer progressHandler:(void (^)(NSProgress *progress))progressHandler completion:(void (^)(NSError *error))completion;
@end
